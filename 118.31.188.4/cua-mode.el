...
(defvar CUA-register-command-prefix "\M-r"
...
;; etags configuration
  (defun create-tags (isvp_for_release)
     "Create tags file."
;     (interactive "DDirectory: ")
     (interactive "/home_a/mqru/work/isvp_for_release ")
     (eshell-command 
      (format "find %s -type f -name \"*.[ch]\" | etags -" isvp_for_release)))
...
;(require '/home_a/mqru/helm-gtags)
